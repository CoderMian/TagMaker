...
struct TagView: View {
    ...
    //Basic Logic
    //Slpitting the array when it exceed the screen size....
    func getRows()->[[Tag]]
    {
        var rows: [[Tag]]=[]
        var currentRow:[Tag]=[]
        ...
        tags.forEach{tag in
            ...
            //adding the capsules size into total width with spacing...
            // 14 + 14 + 6 + 6
            //extra 6 for safety....
            totalWidth += (tag.size + 40)
            //checkin if totalwidth is greater than size...
